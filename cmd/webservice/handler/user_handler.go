...
func (h *Handler) RegisterUserFunc(w http.ResponseWriter, r *http.Request, _ httprouter.Params) {
...
func (h *Handler) LoginFunc(w http.ResponseWriter, r *http.Request, _ httprouter.Params) {
	var user user.User
...
func (h *Handler) UploadProfilePictFunc(w http.ResponseWriter, r *http.Request, _ httprouter.Params) {
	var (
...
// jika username tdk ditemukan, return null
func (h *Handler) GetProfilePictFunc(w http.ResponseWriter, r *http.Request, param httprouter.Params) {
